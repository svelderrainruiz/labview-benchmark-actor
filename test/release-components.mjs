...
const base = {
  ...
  packageLock: { version: '1.4.6', packages: { '': { version: '1.4.6' } } },
  agentsManifest: { version: '0.3.10' },
  agentsText: 'exactly `0.15.5` for this extension build\nbundle v1.0.5',
  lbabusProject: '<Version>0.15.5</Version>',
  humanTasksSource: "HUMAN_TASKS_VERSION = '1.0.5'",
  humanTaskRunner: "HUMAN_TASKS_VERSION = '1.0.5'",
  changelog: '## [1.4.6]',
...
assert.equal(verifyStagedReleaseMetadata({
  staged,
  unstaged: [],
  previous: { extension: '1.4.6', agents: '0.3.10', lbabus: '0.15.5', humanTasks: '1.0.5', experimentGovernance: '1.0.1' },
  current: base.components,
}).ok, false);
