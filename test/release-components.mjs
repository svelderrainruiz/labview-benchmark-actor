...
const base = {
  ...
  packageLock: { version: '1.4.7', packages: { '': { version: '1.4.7' } } },
  agentsManifest: { version: '0.3.11' },
  agentsText: 'exactly `0.15.6` for this extension build\nbundle v1.0.6',
  lbabusProject: '<Version>0.15.6</Version>',
