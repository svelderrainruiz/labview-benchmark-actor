...
const base = {
  ...
  packageJson: { version: '1.4.3' },
  packageLock: { version: '1.4.3', packages: { '': { version: '1.4.3' } } },
  agentsManifest: { version: '0.3.7' },
  agentsText: 'exactly `0.15.2` for this extension build\nbundle v1.0.2',
  lbabusProject: '<Version>0.15.2</Version>',
  humanTasksSource: "HUMAN_TASKS_VERSION = '1.0.2'",
  humanTaskRunner: "HUMAN_TASKS_VERSION = '1.0.2'",
  changelog: '## [1.4.3]',
...
assert.equal(verifyStagedReleaseMetadata({
  staged,
  unstaged: [],
  previous: { extension: '1.4.3', agents: '0.3.7', lbabus: '0.15.2', humanTasks: '1.0.2' },
  current: base.components,
}).ok, false);
