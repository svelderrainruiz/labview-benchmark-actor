...
| LBA-REQ-044 | Remotely automatable Ubuntu golden base and provisioner | Proven | §3.2 Deployment | ADR-0023 | T-044 | 15 |
...
| LBA-REQ-055 | Handoff Beacon -- capture-status (human-in-the-loop signal) | Proven | §3.2 Deployment | ADR-0035 | T-055 | 9 |
...
_Generated for 97 requirements._
