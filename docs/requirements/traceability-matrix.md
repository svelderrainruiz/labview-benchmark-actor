...
| LBA-REQ-095 | System-level SemVer, task chronology, and canonical distribution | Proven | — | ADR-0078 | T-095 | 12 |
| LBA-REQ-096 | Standards scorecard release-risk overlay | Proven | — | ADR-0079 | T-096 | 9 |
| LBA-REQ-097 | Experiment lifecycle and local continuous KPI | Proven | — | ADR-0080 | T-097 | 14 |
