...
### 2.1 Local gate suite — 209 fail-closed checks
...
| Governed gates | 209 | experiments/verify-local-gates.mjs |
...
_Generated from 209 gates, 7 correspondence rules, 97 requirements, 80 ADRs, 96 test items._
