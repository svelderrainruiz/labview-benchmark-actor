...
### 2.1 Local gate suite — 200 fail-closed checks
...
| --- | --- | --- |
| Requirements (total) | 94 | docs/requirements/srs.md, rtm.csv |
| — Status: Proven | 93 | rtm.csv |
| — Status: Superseded | 1 | rtm.csv |
| Architecture decisions (ADRs) | 77 | docs/architecture/adr/README.md |
| Governed gates | 200 | experiments/verify-local-gates.mjs |
| Correspondence rules | 7 | experiments/reqs-coverage/verify-correspondences.mjs |
| Governed test items | 93 | docs/testing/test-plan.md |
...
_Generated from 200 gates, 7 correspondence rules, 94 requirements, 77 ADRs, 93 test items._
