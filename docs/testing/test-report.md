...
### 2.1 Local gate suite — 197 fail-closed checks
...
| Governed gates | 197 | experiments/verify-local-gates.mjs |
...
_Generated from 197 gates, 7 correspondence rules, 93 requirements, 76 ADRs, 92 test items._
