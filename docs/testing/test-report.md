...
### 2.1 Local gate suite — 207 fail-closed checks
...
| Governed gates | 207 | experiments/verify-local-gates.mjs |
...
_Generated from 207 gates, 7 correspondence rules, 97 requirements, 80 ADRs, 96 test items._
