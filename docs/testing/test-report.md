...
### 2.1 Local gate suite — 208 fail-closed checks
...
| Governed gates | 208 | experiments/verify-local-gates.mjs |
...
_Generated from 208 gates, 7 correspondence rules, 97 requirements, 80 ADRs, 96 test items._
